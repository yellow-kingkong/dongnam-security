      ...
      <div className="mx-auto max-w-7xl px-4 md:px-6">
        ...
        <ul className="mt-12 grid grid-cols-2 gap-4 md:grid-cols-3 md:gap-6">
          {complexes.map((complex) => (
            <li
              key={complex.id}
              className="rounded-lg transition duration-200 hover:-translate-y-1 hover:shadow-md"
            >
              <img
                src={complex.image}
                alt={complex.name}
              ...
              />
              <div className="rounded-b-lg border border-t-0 border-line bg-white p-3 md:p-4">
